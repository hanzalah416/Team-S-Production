...
export function MedicineDeliveryDisplay(props: {
    ...
    return (
        <TableRow>
            <StyledTableCell align="center">{props.MedicineDeliveryForm.requestID}</StyledTableCell>
            <StyledTableCell align="center">{props.MedicineDeliveryForm.name}</StyledTableCell>
