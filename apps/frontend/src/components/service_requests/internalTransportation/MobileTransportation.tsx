  ...
  return (
    ...
    >
      <div className={"mainBox"}>
        <p className={"title-mobile"}>Internal Transportation Request Form</p>
          ...
          >
            ...
            <div>
              ...
              <Autocomplete
                ...
                onOpen={() => toggleScrolling(true)}
                onClose={() => toggleScrolling(false)}
                onChange={(event, value) => handleChangeDropOffLocation(value)}
              />
            </div>
          </Stack>
          <Stack
          ...
          >
            <div>
              ...
              <Select
                ...
                onChange={handleChangeTransportationType}
              >
