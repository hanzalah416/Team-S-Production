...
import { DataGrid, GRID_CHECKBOX_SELECTION_COL_DEF, GridRowId } from "@mui/x-data-grid";
...
export default function EmailForm() {
    ...
    async function handleSubmitMultiple(e: React.FormEvent<HTMLFormElement>) {
        selectedRows.forEach(function (x) {
            handleSubmit(e, x);
        });
    }

    async function handleSubmit(e: React.FormEvent<HTMLFormElement>, x: GridRowId) {
        e.preventDefault();
